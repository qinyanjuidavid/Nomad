...
from modules.accounts.views import (AdminRegistrationViewSet, LoginViewSet,
                                    NomadRegistrationViewSet,
                                    PasswordResetTokenCheck, RefreshViewSet,
...
routes.register(r'register', NomadRegistrationViewSet,
                basename='register')
