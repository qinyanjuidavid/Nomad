...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ("id", "username", "full_name", "email", "phone", "timestamp")
...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ["username", "email", "phone", "password", "password_confirmation"]
...
class NomadProfileSerializer(GeoFeatureModelSerializer):
